...
export function AdminPanel() {
  ...
  const getRoleBadge = (r) => { const n = (r || '').toUpperCase(); if (n === 'ADMIN') return { cls: 'bg-primary/15 text-primary border-primary/30', label: 'Admin' }; if (n === 'TRAINER' || n === 'TRENER') return { cls: 'bg-blue-900/40 text-blue-400 border-blue-800/50', label: 'Trener' }; return { cls: 'bg-secondary text-foreground border-border', label: r || 'Korisnik' }; };
